...
// App.jsx (updated to match production header colors, preserve ALL features, and add EliteChanceMe)
...
const Navigation = ({ isScrolled, setIsMenuOpen }) => {
  ...
  const navigationItems = [
    ...
    { id: 'elite', label: 'Elite ChanceMe', icon: <Star size={16} />, path: '/elite-chance-me' }, // NEW
  ];

  return (
    <header className="fixed top-0 left-0 right-0 z-30">
      {/* Gradient tuned to production look */}
...
const App = () => {
  ...
  return (
    <HelmetProvider>
      <BrowserRouter>
        {/* Top Navigation */}
        <Navigation isScrolled={scrollPosition > 50} setIsMenuOpen={setIsMenuOpen} />
